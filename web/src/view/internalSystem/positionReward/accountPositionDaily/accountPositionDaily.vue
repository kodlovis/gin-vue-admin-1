<template>
  <div>
    ...
    <el-table-column label="instrument字段" prop="instrument" width="120"></el-table-column> 
    
    <el-table-column label="direction字段" prop="direction" width="120"></el-table-column> 
    
    <el-table-column label="hedgeFlag字段" prop="hedgeFlag" width="120"></el-table-column> 
    
    <el-table-column label="amount字段" prop="amount" width="120"></el-table-column> 
