...
import (
	...
	"gin-vue-admin/router/internalSystem/futureData"
...
func Routers() *gin.Engine {
	...
	PrivateGroup.Use(middleware.JWTAuth()).Use(middleware.CasbinHandler())
	{
		...
		futureData.InitSpotDetailRouter(PrivateGroup)
		futureData.InitRightsDetailRouter(PrivateGroup)
		futureData.InitForexFutureDetailRouter(PrivateGroup)
