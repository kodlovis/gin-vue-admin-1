...
type Us002FutureBasisOfInstrumentClose struct {
	...
	DepartmentName          Department `json:"departmentName" gorm:"foreignKey:DepartmentCode;references:DepartmentCode;comment:"`
}
...
type PositionDeliveryMonthInstrument struct {
	...
	Product            string               `json:"product" form:"product" gorm:"column:product_code;comment:;type:varchar;"`
	DepartmentMame     string               `json:"departmentName" form:"departmentName" gorm:"column:department_name;comment:;type:varchar;"`
